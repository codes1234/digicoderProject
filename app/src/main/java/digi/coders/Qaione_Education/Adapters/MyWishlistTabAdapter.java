...
import digi.coders.Qaione_Education.Fragments.CourseWishlistFragment;
...
public class MyWishlistTabAdapter extends FragmentStatePagerAdapter {


    private Context myContext;
    int totalTabs;

    public MyWishlistTabAdapter(Context context, FragmentManager fm, int totalTabs) {
        super(fm);
        myContext = context;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                CourseWishlistFragment myCoursesFragment=new CourseWishlistFragment();
